...
def print_help():
    ...
    all_data = [
        ...
        ("enumerate_delegation_chains [proj] [sa]", "Discover implicitDelegation by testing actual chains (works without IAM read!)"),
        ("enumerate_drive [query] [max]", "List Google Drive files (with permissions analysis, highlights publicly shared files)"),
        ("enumerate_exploitable_sas [project]", "Find SAs where you have dangerous permissions (impersonate, signJwt, etc.)"),
